...
from book_database_app.config.loggers import logger_db
from book_database_app.config.glob_vars import PATH_DB_BOOK,PATH_DB_BOOK_BACK
from book_database_app.domain.book import Book
...
class BooksDatabase():
    ...
    def __init__(self):
        try:
            ...
            self.db = sqlite3.connect(PATH_DB_BOOK)
    ...
    def close_db(self):
        shutil.copyfile(PATH_DB_BOOK,PATH_DB_BOOK_BACK)
        self.db.close()
